...
exports.GiangVienService = void 0;
...
let GiangVienService = class GiangVienService {
    ...
    async findOne(id) {
        ...
        if (!gv)
            throw new common_1.NotFoundException(`Không tìm thấy giảng viên id=${id}`);
        return gv;
    }
...
exports.GiangVienService = GiangVienService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(giang_vien_entity_1.GiangVien)),
